...
const StudentLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { name: 'Đơn ứng tuyển', href: '/student/internship-application', icon: BriefcaseIcon },
    { name: 'Báo cáo', href: '/student/reports', icon: DocumentTextIcon },
    { name: 'Đánh giá', href: '/student/evaluations', icon: StarIcon },
    { name: 'Hồ sơ cá nhân', href: '/student/profile', icon: UserIcon },
  ];
        ...
        <div className="flex items-center justify-between h-20 px-6 bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 shadow-lg">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-100 text-xs font-medium">Cổng thông tin sinh viên</p>
            </div>
          </div>
          <button
          ...
          <div className="flex items-center justify-between h-20 px-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Chào mừng trở lại, {user?.fullName || 'Sinh viên'}</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden md:flex items-center space-x-2 bg-gray-100 rounded-xl px-4 py-2.5 min-w-[300px]">
                ...
                <input
                  type="text"
                  placeholder="Tìm kiếm cơ hội thực tập..."
              ...
              <div className="flex items-center space-x-3 pl-4 border-l border-gray-200">
                <div className="text-right hidden sm:block">
                  <p className="text-sm font-semibold text-gray-800">{user?.fullName || 'Sinh viên'}</p>
