...
const MentorLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { name: 'Đánh giá Sinh viên', href: '/mentor/student-evaluation', icon: DocumentTextIcon },
    { name: 'Theo dõi Thực tập', href: '/mentor/internship-tracking', icon: UserGroupIcon },
  ];
      ...
      <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 left-0 z-50 w-72 bg-white shadow-2xl transform transition-all duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 border-r border-gray-200`}>
        ...
        <div className="flex items-center justify-between h-20 px-6 bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 shadow-lg">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white tracking-tight">Mentor Portal</h1>
              <p className="text-blue-100 text-xs font-medium">Cổng thông tin mentor</p>
            </div>
          </div>
          <button
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
                  Cổng thông tin mentor
                </h2>
                <p className="text-sm text-gray-500 mt-1">Chào mừng trở lại, {user?.fullName || 'Mentor'}</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3 pl-4 border-l border-gray-200">
                <div className="text-right hidden sm:block">
                  <p className="text-sm font-semibold text-gray-800">{user?.fullName || 'Mentor'}</p>
