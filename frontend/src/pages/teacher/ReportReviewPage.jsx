...
const ReportReviewPage = () => {
  ...
  const handleExportReports = () => {
    const csvData = [
      ['Tiêu đề', 'Sinh viên', 'Mã SV', 'Công ty', 'Trạng thái', 'Điểm', 'Ngày nộp', 'Phản hồi'].join(','),
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">
                Đánh giá báo cáo: {selectedReport.title}
              </h3>
              
              <div className="mb-4">
                {(() => {
                  const student = selectedReport.internship?.student || selectedReport.student;
                  const company = selectedReport.internship?.company;
                  return (
                    <>
                      <p className="text-gray-600">
                        Sinh viên: {student?.user?.fullName || 'N/A'} ({student?.studentCode || 'N/A'})
                      </p>
                      <p className="text-gray-600">
                        Công ty: {company?.companyName || 'N/A'}
                      </p>
                    </>
                  );
                })()}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setReviewData({...reviewData, score: parseFloat(e.target.value)})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <p className="text-sm text-gray-600">
                        Họ tên: {selectedReport.internship?.student?.user?.fullName || selectedReport.student?.user?.fullName || 'N/A'}
                      </p>
                      <p className="text-sm text-gray-600">
                        Mã SV: {selectedReport.internship?.student?.studentCode || selectedReport.student?.studentCode || 'N/A'}
                      </p>
                      <p className="text-sm text-gray-600">
                        Công ty: {selectedReport.internship?.company?.companyName || 'N/A'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <p className="text-sm text-gray-600">
                        Loại: {selectedReport.type || 'N/A'}
                      </p>
                      <p className="text-sm text-gray-600">
                        Ngày nộp: {formatDate(selectedReport.submittedAt)}
                      </p>
                      ...
                      {selectedReport.teacherScore && (
                        <p className="text-sm text-gray-600">
                          Điểm: {selectedReport.teacherScore}/10
                        </p>
                      )}
                    </div>
                  </div>
        ...
        {showBulkActions && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">
                Hành động hàng loạt ({selectedReports.length} báo cáo)
              </h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Nhập phản hồi áp dụng cho tất cả báo cáo được chọn..."
                  />
                </div>
              </div>
