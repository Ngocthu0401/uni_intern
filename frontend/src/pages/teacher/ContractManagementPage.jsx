...
import { contractService, teacherService, internshipService, apiHelpers } from '../../services';
...
const ContractManagementPage = () => {
  ...
  }, [teacherData?.id, pagination.page, pagination.size, searchKeyword, filterStatus]);
  ...
  const loadContracts = async () => {
    ...
    try {
      ...
      const response = await contractService.getContractsByTeacher(teacherData.id, params);
  ...
  const loadAvailableInternships = async () => {
    ...
    try {
      ...
      const response = await internshipService.getInternshipsByTeacher(teacherData.id);
      setAvailableInternships(response.data || response || []);
    } catch (err) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Quản lý Hợp đồng Hỗ trợ</h1>
