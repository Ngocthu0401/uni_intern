...
mysql -u root -e "USE internship_management; SELECT 1;" >nul 2>&1
if %errorlevel% neq 0 (
...
mysqldump -u root internship_management > %backup_file% 2>nul
if %errorlevel% equ 0 (
...
REM Execute demo data script
echo Executing demo data generation script...
echo This may take a few minutes...
echo.

mysql -u root internship_management < generate_demo_data.sql
if %errorlevel% equ 0 (
    echo.
    echo ========================================
