...
public class StudentService {
    ...
    public Page<StudentWithInternshipsDto> getAllStudentsWithInternships(Pageable pageable) {
        ...
        List<StudentWithInternshipsDto> studentDtos = studentsPage.getContent().stream()
            .map(student -> {
                ...
                List<Internship> studentInternships = student.getInternships() != null ? 
                    student.getInternships() : List.of();
    ...
    // Advanced search method for StudentController
    public Page<Student> advancedSearchStudents(
        ...
        return studentRepository.advancedSearch(
    ...
    public List<Map<String, Object>> getRecentActivities(int limit) {
        ...
        return recentStudents.getContent().stream()
            .map(student -> {
                ...
                activity.put("description", "Student: " + student.getUser().getFullName() + " - " + student.getStudentCode());
    ...
    private StudentWithInternshipsDto createStudentDto(Student student, List<Internship> studentInternships) {
        ...
        // Convert internships to DTOs (without student reference to avoid circular reference)
